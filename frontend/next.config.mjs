// Plain JavaScript on purpose: `next start` reads this file at runtime, and a
// TypeScript config would need the TypeScript compiler in the production
// image, which ships without dev dependencies.
